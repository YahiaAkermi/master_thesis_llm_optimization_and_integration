...
% TODO: Add reference to application.yaml configuration (lines 25-35)
...
% TODO: Add reference to pom.xml configuration (lines 38-42)
...
% TODO: Add reference to application.yaml configuration (lines 5-7)
...
% TODO: Add reference to pom.xml configuration (lines 30-32)
...
% TODO: Add Figure 2.1: High-Level System Architecture
...
% TODO: Add reference to lines 45-65 and 140-150
...
% TODO: Add reference to AsyncConfig.java (lines 15-40)
% TODO: Add reference to McpLlmService (lines 25-45)
...
% TODO: Add Figure 2.2: Service Layer Architecture Diagram
...
% TODO: Add code reference to LlmService.java initialization sequence (lines 42-68)
...
% TODO: Add code reference to validation process (lines 60-68)
...
% TODO: Add code reference to InferenceParameters configuration (lines 78-95)
...
% TODO: Add code reference to RestLlmController.java implementation (lines 15-35)
...
% TODO: Add code reference to RestLlmService.java implementation (lines 20-40)
...
% TODO: Add Figure 4.1: REST API Processing Flow Diagram
...
% TODO: Add code reference to McpLlmController.java implementation (lines 20-45)
...
% TODO: Add code reference to McpLlmService.java implementation (lines 25-60)
...
% \begin{lstlisting}[language=Java, caption=MCP Service Implementation Pattern]
% % @Service
% % @Slf4j
% % public class McpLlmService {
% %     private static final String INTEGRATION_PATTERN = "MCP";
% %     
% %     @Autowired
% %     private LlmService llmService;
% %     
% %     @Async("mcpThreadPool")
% %     public CompletableFuture<CompletionResponse> generateCompletionAsync(
% %             CompletionRequest request) {
% %         long asyncStartTime = System.nanoTime();
% %         
% %         return CompletableFuture.supplyAsync(() -> {
% %             long coreProcessingStart = System.currentTimeMillis();
% %             CompletionResponse response = 
% %                 llmService.generateCompletion(request, INTEGRATION_PATTERN);
% %             
% %             long asyncOverheadNanos = System.nanoTime() - asyncStartTime - 
% %                 (response.getProcessingTimeMs() * 1_000_000);
% %             double asyncOverheadMs = asyncOverheadNanos / 1_000_000.0;
% %             
% %             log.info("MCP Performance Breakdown - Async Overhead: {}ms, " + 
% %                     "Core Processing: {}ms", 
% %                     String.format("%.3f", asyncOverheadMs), 
...
% TODO: Add complete code reference to McpLlmService.java
...
% \begin{lstlisting}[language=Java, caption=Async Configuration for MCP]
% % @Configuration
% % @EnableAsync
% % public class AsyncConfig implements AsyncConfigurer {
% %     
% %     @Bean(name = "mcpThreadPool")
...
% %             log.error("Uncaught async error in MCP processing", ex);
% %             // Additional error handling and measurement recording
% %         };
% %     }
% }
% \end{lstlisting}

% TODO: Add complete code reference to AsyncConfig.java

% TODO: Add Figure 4.2: MCP Async Processing Architecture Diagram
...
% TODO: Add code reference to StreamingLlmController.java implementation (lines 20-40)
...
% TODO: Add code reference to token processing pipeline (lines 40-80)
...
% \begin{lstlisting}[language=Java, caption=Streaming Service Implementation]
% % @Service
% % @Slf4j
% % public class StreamingLlmService {
% %     private static final String INTEGRATION_PATTERN = "SSE";
% %     
% %     @Autowired
% %     private LlmService llmService;
% %     
% %     public void generateCompletionStreaming(CompletionRequest request, 
% %             SseEmitter emitter) {
...
% %             
% %             emitter.onTimeout(() -> {
% %                 log.warn("Streaming completion timed out");
% %                 isCancelled.set(true);
% %             });
% %             
% %             try {
% %                 llmService.generateCompletionStreaming(
% %                     request, 
% %                     INTEGRATION_PATTERN,
% %                     token -> {
% %                         if (!isCancelled.get()) {
...
% %                             } catch (IOException e) {
% %                                 log.error("Error sending streaming token: {}", 
% %                                     e.getMessage());
% %                                 isCancelled.set(true);
% %                             }
% %                         }
...
% TODO: Add complete code reference to StreamingLlmService.java
...
% \begin{lstlisting}[language=Java, caption=Streaming Controller Implementation]
% % @RestController
% % @RequestMapping("/api/llm/streaming")
% % @Slf4j
% % public class StreamingLlmController {
% %     private static final long SSE_TIMEOUT = 60000L; // 60 seconds
% %     
% %     @Autowired
% %     private StreamingLlmService streamingLlmService;
% %     
% %     @PostMapping(value = "/complete", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
% %     public SseEmitter completeStreaming(@RequestBody CompletionRequest request) {
% %         SseEmitter emitter = new SseEmitter(SSE_TIMEOUT);
% %         
% %         log.info("Starting SSE streaming completion");
% %         streamingLlmService.generateCompletionStreaming(request, emitter);
% %         
% %         return emitter;
% %     }
% }
...
% TODO: Add complete code reference to StreamingLlmController.java
...
% TODO: Add Figure 4.3: SSE Streaming Communication Flow Diagram
...
% \begin{lstlisting}[language=Java, caption=Metrics Service Implementation]
% % @Service
% % @Slf4j
...
% %         Gauge.builder("system.cpu.usage", this, MetricsService::getCpuUsage)
% %             .description("CPU usage percentage")
% %             .register(meterRegistry);
% %         
% %         Gauge.builder("jvm.memory.heap.used", this, MetricsService::getMemoryUsage)
% %             .description("JVM heap memory usage in MB")
% %             .register(meterRegistry);
% %     }
% %     
...
% \begin{lstlisting}[language=Java, caption=Prometheus Metrics Registration]
% % private void registerPrometheusMetrics(String pattern, Double latency, 
% %                                       Integer throughput, Double cpu, 
% %                                       Double memory) {
% %     // Average latency per integration pattern
% %     Gauge.builder("llm_average_latency_ms", this, 
% %             ms -> latency != null ? latency : 0.0)
% %         .description("Average LLM response latency in milliseconds")
% %         .tag("integration_pattern", pattern)
% %         .register(meterRegistry);
% %         
% %     // Throughput per integration pattern  
% %     Gauge.builder("llm_throughput_requests_per_minute", this, 
% %             ms -> throughput != null ? throughput.doubleValue() : 0.0)
% %         .description("LLM requests processed per minute")
% %         .tag("integration_pattern", pattern)
% %         .register(meterRegistry);
% %         
% %     // System resource metrics
% %     Gauge.builder("llm_cpu_usage_percent", this, 
% %             ms -> cpu != null ? cpu : 0.0)
% %         .description("CPU usage percentage during LLM processing")
% %         .register(meterRegistry);
% %         
% %     Gauge.builder("llm_memory_usage_mb", this, 
% %             ms -> memory != null ? memory : 0.0)
% %         .description("Memory usage in MB during LLM processing")
% % %         .register(meterRegistry);
% % }
% \end{lstlisting}

% TODO: Add complete code reference to Prometheus metrics registration
...
% TODO: Add Figure 5.2: Prometheus Integration Data Flow Diagram
...
% TODO: Add reference to LlmRequest.java entity design (lines 1-40)
...
% TODO: Add reference to ModelMetrics.java entity design (lines 1-35)
